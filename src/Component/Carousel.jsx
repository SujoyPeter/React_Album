                                ...
                                <React.Fragment>
                                    {
                                        (
                                            ...
                                            <div key={item.id} className="carousel-item active" data-bs-interval="5000" >
                                                ...
                                                {item.id === 1 && < img height={"350px"} width={"500px"} src="https://www.shutterstock.com/image-vector/realistic-vinyl-record-cover-mockup-260nw-727832998.jpg" alt="..." />}
                                                {item.id === 11 && < img height={"350px"} width={"500px"} src="https://media.istockphoto.com/id/1372320636/vector/vinyl-record.jpg?s=612x612&w=0&k=20&c=SE_lS4FNiEl2XjvGBBcnvS13W5ogI_toQKRRueK7Hjs=" alt="..." />}
                                                {item.id === 21 && < img height={"350px"} width={"500px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRS3R7xaFP5R9TrBL-YOCvB_lL4HWNsuYQMOwJyU5xHzInisx2QAQpzYsBD3akhHWgryEM&usqp=CAU" alt="..." />}
                                                {item.id === 31 && < img height={"350px"} width={"500px"} src="https://secure.img1-cg.wfcdn.com/im/36179830/resize-h210-w210%5Ecompr-r85/1754/175453444/Vinyl+Record+In+Music+Room+-+Wrapped+Canvas+Textual+Art.jpg" alt="..." />}
                                                {item.id === 41 && < img height={"350px"} width={"500px"} src="https://wallpapers.com/images/hd/cover-art-background-1000-x-996-moopsnulmsdw8pay.jpg" alt="..." />}
                                                {item.id === 51 && < img height={"350px"} width={"500px"} src="https://images.template.net/107007/music-cover-background-e9u0o.jpg" alt="..." />}
                                                {item.id === 61 && < img height={"350px"} width={"500px"} src="https://png.pngtree.com/background/20220731/original/pngtree-background-for-guitar-music-performance-picture-image_1911929.jpg" alt="..." />}
                                                {item.id === 71 && < img height={"350px"} width={"500px"} src="https://png.pngtree.com/background/20210711/original/pngtree-guitar-music-club-recruits-new-background-picture-image_1087238.jpg" alt="..." />}
                                                {item.id === 81 && < img height={"350px"} width={"500px"} src="https://media.istockphoto.com/id/164470700/vector/music-background.jpg?s=612x612&w=0&k=20&c=-gxk5-_YSualu6gt9UgXJzp7dcIlcg4LQOik9uc4fAY=" alt="..." />}
                                                {item.id === 91 && < img height={"350px"} width={"500px"} src="https://thumbs.dreamstime.com/z/seamless-music-background-cute-notes-light-eps-funny-wallpaper-chaotic-musical-theme-template-packaging-cover-187292972.jpg" alt="..." />}
                                            ...
                                            <div key={item.id} className="carousel-item" data-bs-interval="5000">
                                                ...
                                                {(item.id > 1 && item.id < 11) && < img height={"350px"} width={"500px"} src="https://www.shutterstock.com/image-vector/realistic-vinyl-record-cover-mockup-260nw-727832998.jpg" alt="..." />}
                                                {(item.id > 11 && item.id < 21) && < img height={"350px"} width={"500px"} src="https://media.istockphoto.com/id/1372320636/vector/vinyl-record.jpg?s=612x612&w=0&k=20&c=SE_lS4FNiEl2XjvGBBcnvS13W5ogI_toQKRRueK7Hjs=" alt="..." />}
                                                {(item.id > 21 && item.id < 31) && < img height={"350px"} width={"500px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRS3R7xaFP5R9TrBL-YOCvB_lL4HWNsuYQMOwJyU5xHzInisx2QAQpzYsBD3akhHWgryEM&usqp=CAU" alt="..." />}
                                                {(item.id > 31 && item.id < 41) && < img height={"350px"} width={"500px"} src="https://secure.img1-cg.wfcdn.com/im/36179830/resize-h210-w210%5Ecompr-r85/1754/175453444/Vinyl+Record+In+Music+Room+-+Wrapped+Canvas+Textual+Art.jpg" alt="..." />}
                                                {(item.id > 41 && item.id < 51) && < img height={"350px"} width={"500px"} src="https://wallpapers.com/images/hd/cover-art-background-1000-x-996-moopsnulmsdw8pay.jpg" alt="..." />}
                                                {(item.id > 51 && item.id < 61) && < img height={"350px"} width={"500px"} src="https://images.template.net/107007/music-cover-background-e9u0o.jpg" alt="..." />}
                                                {(item.id > 61 && item.id < 71) && < img height={"350px"} width={"500px"} src="https://png.pngtree.com/background/20220731/original/pngtree-background-for-guitar-music-performance-picture-image_1911929.jpg" alt="..." />}
                                                {(item.id > 71 && item.id < 81) && < img height={"350px"} width={"500px"} src="https://png.pngtree.com/background/20210711/original/pngtree-guitar-music-club-recruits-new-background-picture-image_1087238.jpg" alt="..." />}
                                                {(item.id > 81 && item.id < 91) && < img height={"350px"} width={"500px"} src="https://media.istockphoto.com/id/164470700/vector/music-background.jpg?s=612x612&w=0&k=20&c=-gxk5-_YSualu6gt9UgXJzp7dcIlcg4LQOik9uc4fAY=" alt="..." />}
                                                {(item.id > 91 && item.id < 101) && < img height={"350px"} width={"500px"} src="https://thumbs.dreamstime.com/z/seamless-music-background-cute-notes-light-eps-funny-wallpaper-chaotic-musical-theme-template-packaging-cover-187292972.jpg" alt="..." />}
